...
// Official Apple Music icon (color variant), Apple Music Identity Guidelines, used as-is.
// Apple ships fixed-color artwork, so this is a deliberate exception to the design system's
// currentColor monochrome convention; do not recolor or simplify the glyph. The gradient id
// is per-instance (useId) so many rows can render the icon without colliding on a shared id.
